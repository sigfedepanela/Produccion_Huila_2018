...
var style_ProduccindePanelaToneladas_2 = function(feature, resolution){
    ...
    if (value >= 21.230000 && value <= 470.220000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 470.220000 && value <= 1029.820000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1029.820000 && value <= 2102.100000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2102.100000 && value <= 8261.680000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 8261.680000 && value <= 22507.300000) {
            style = [ new ol.style.Style({
